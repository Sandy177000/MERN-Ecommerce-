...
export default function AdminProductList() {
  ...
  // hook to call reducer functions
  const dispatch = useDispatch();

  // selecting list of products from the state
  ...
  const handleFilter = (e, section, option) => {
    ...
    // If the button is checked only then push it in filter object
    if (e.target.checked) {
  ...
  // if promise object of products is received then useeffect calls dispatch which fetches data
  useEffect(() => {
                  ...
                  <div className="lg:col-span-3">
                    <div>
                      <Link
                        ...
                        className="rounded-md mx-10 bg-green-600 px-3 py-2 my-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      >
                        Add New Product
                      </Link>
                    </div>
                            ...
                            {products.map((product) => (
                              <div className="h-200">
                                <Link to={`/product-details/${product.id}`}>
                                  <div
                                    key={product.id}
                                    className="solid border-2 p-2 group relative"
                                  >
                                    <div
