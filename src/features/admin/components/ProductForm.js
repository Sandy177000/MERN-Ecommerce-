...
export default function ProductForm() {
  ...
  const product = useSelector(selectedProductById); // gets value from the state

  // set the selectedProduct property of product state
  useEffect(() => {
    if (params.id) {
      dispatch(fetchProductByIdAsync(params.id)); // calls api gets the product and sets the value in state
    }else{
        dispatch(clearSelectedProduct());
    }
  }, [params.id]);

  // set the values of the selected product in the form
  useEffect(()=>{
